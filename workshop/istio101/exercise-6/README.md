...
View the guestbook application, access the OpenShift route you created earlier. 
...
View the guestbook application using the OpenShift Route specified in [Exercise 5](../exercise-5/README.md) and enter it as a URL in Firefox or Chrome web browsers. **Ensure that you are using a hard refresh (command + Shift + R on Mac or Ctrl + F5 on windows) to remove any browser caching.** You should notice that the guestbook should swap between V1 or V2 at about the weight you specified.
...
![kiali1](../README_images/kiali-1.png)
...
![kiali2](../README_images/kiali-2.png)
